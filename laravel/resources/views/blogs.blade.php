...
<body class="relative min-h-screen flex flex-col">
    ...
    <nav
        ...
        <div id="mobile-menu"
            ...
            <a href="/contact-us" class="mobile-nav-link text-gray-200 hover:text-white transition-colors">Contact
                Us</a>
        </div>
    </nav>
    ...
    <main class="flex-1 max-w-[1400px] w-full mx-auto px-6 md:px-10 py-12 md:py-20 z-10 relative">
        ...
        <section id="blogs" class="w-full flex flex-col items-center">
            <!-- Badge -->
            <div
                class="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-[#1e40af] bg-gradient-to-r from-blue-600 to-blue-500 mb-6 shadow-[0_0_20px_rgba(59,130,246,0.3)]">
            ...
            <!-- Heading -->
            <h2 class="text-[32px] md:text-[44px] font-bold text-white mb-4 text-center tracking-tight max-w-4xl">
                Empowering the Future of Business with Modern Digital Solutions</h2>
            <p class="text-[#9ca3af] text-[15px] md:text-[16px] text-center max-w-3xl mb-16 leading-relaxed">
                Welcome to the Aura Infotech Blog — where strategy meets storytelling and technology fuels
                transformation.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-[1200px] mx-auto">
                <!-- Card 1 -->
                <a href="/blog/ui-design-principles"
                    class="bg-[#080808]/60 border border-white/[0.05] rounded-[24px] overflow-hidden cursor-pointer flex flex-col hover:border-[#00e5ff]/30 hover:-translate-y-1 transition-all duration-300 group shadow-lg">
                    <div class="w-full h-[240px] overflow-hidden relative bg-[#130d26]">
                        <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&h=400&fit=crop"
                            alt="UI Design"
                            class="w-full h-full object-cover opacity-80 mix-blend-screen transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-[#080808] to-transparent"></div>
                    </div>
                    <div class="p-8 pt-6 flex-1 flex flex-col">
                        <h3
                            class="text-[19px] font-bold text-white mb-3 leading-snug group-hover:text-[#00e5ff] transition-colors">
                            UI Design Principles That Enhance User Engagement</h3>
                        <p class="text-[#8c92a0] text-[14px] leading-relaxed">
                            User Interface (UI) design is much more than just making a website look pretty. It's about
                ...
                <!-- Card 2 -->
                <a href="/blog/boost-ecommerce-sales"
                    class="bg-[#080808]/60 border border-white/[0.05] rounded-[24px] overflow-hidden cursor-pointer flex flex-col hover:border-[#00e5ff]/30 hover:-translate-y-1 transition-all duration-300 group shadow-lg">
                    ...
                    <div class="p-8 pt-6 flex-1 flex flex-col">
                        <h3
                            class="text-[19px] font-bold text-white mb-3 leading-snug group-hover:text-[#00e5ff] transition-colors">
                            Boost Online Sales with Smart E-Commerce</h3>
                        <p class="text-[#8c92a0] text-[14px] leading-relaxed">
                            In the rapidly evolving digital marketplace, e-commerce is no longer just about setting up a
                            storefront.
                        </p>
                    </div>
                </a>
                ...
                <!-- Card 3 -->
                <a href="/blog/scalable-web-solutions"
                    class="bg-[#080808]/60 border border-white/[0.05] rounded-[24px] overflow-hidden cursor-pointer flex flex-col hover:border-[#00e5ff]/30 hover:-translate-y-1 transition-all duration-300 group shadow-lg">
                    ...
                    <div class="p-8 pt-6 flex-1 flex flex-col">
                        <h3
                            class="text-[19px] font-bold text-white mb-3 leading-snug group-hover:text-[#00e5ff] transition-colors">
                            The Power of Scalable Web Solutions</h3>
                        <p class="text-[#8c92a0] text-[14px] leading-relaxed">
                            In the fast-paced digital economy, businesses need solutions that can handle millions of
                            dynamic users.
                        </p>
                    </div>
                </a>
        ...
        <div class="max-w-[1200px] mx-auto px-6 md:px-10 flex flex-col items-center">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <svg width="40" height="20" viewBox="0 0 100 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M24 44C12.9543 44 4 35.0457 4 24C4 12.9543 12.9543 4 24 4C31.5435 4 38.0772 8.16335 41.5173 14.5029L58.4827 33.4971C61.9228 39.8367 68.4565 44 76 44C87.0457 44 96 35.0457 96 24C96 12.9543 87.0457 4 76 4C68.4565 4 61.9228 8.16335 58.4827 14.5029L41.5173 33.4971C38.0772 39.8367 31.5435 44 24 44Z"
                        stroke="url(#paint0_linear_footer_blogs_page)" stroke-width="8" stroke-linecap="round" />
                    <defs>
                        <linearGradient id="paint0_linear_footer_blogs_page" x1="4" y1="24" x2="96" y2="24"
